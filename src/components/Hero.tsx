    ...
    >
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        <div className="max-w-3xl">
          {/* Greeting */}
          <p
            className="text-sm font-display font-medium tracking-widest uppercase mb-4 animate-fade-up"
            style={{
              color: "#F5A623",
              animationDelay: "0.1s",
              opacity: 0,
          ...
          {/* Name */}
          <h1
            className="font-display font-bold text-6xl sm:text-7xl md:text-8xl text-white mb-4 animate-fade-up"
            style={{
              animationDelay: "0.2s",
              opacity: 0,
              animationFillMode: "forwards",
          ...
          {/* Subtitle */}
          <p
            className="text-base sm:text-lg leading-relaxed max-w-xl mb-10 animate-fade-up"
            style={{
              color: "#A8B8C8",
              animationDelay: "0.5s",
              opacity: 0,
          ...
          >
            ...
            <a
              href="assets/Birhane_Weldeslasse_In_dutch.pdf"
              download
        ...
        {/* Scroll indicator */}
        <div
          className="absolute bottom-8 left-0 flex flex-col items-center gap-2 animate-fade-up"
          style={{
            animationDelay: "1s",
            opacity: 0,
            animationFillMode: "forwards",
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to bottom, transparent, rgba(245,166,35,0.4))",
            }}
          />
          <div
